...
public class workwithJSONandXML : MonoBehaviour
{
    ...
    IEnumerator getData()
    {
        ...
        else
        {
            ...
            field.text = $"Необходимый \nинструмент: {jsnData.equipmentName.ToString()} \nЦена: {jsnData.equipmentPrice.ToString()}";
